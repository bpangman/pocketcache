...
const cards = [
  { html: 'r3-01-coin-o-squircle.html',    out: 'r3-01-coin-o-squircle.png'    },
  { html: 'r3-02-coin-o-tall-token.html',   out: 'r3-02-coin-o-tall-token.png'   },
  { html: 'r3-03-coin-o-geometric.html',    out: 'r3-03-coin-o-geometric.png'    },
];
...
await context.close();
await browser.close();
console.log('All 3 round-3 logos rendered successfully.');
